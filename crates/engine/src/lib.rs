...
pub use prefilter::set_prefilter_disabled;
use prefilter::{prefilter_allows, prefilter_disabled, prefilter_haystack, rule_prefilter};
use text_scan::{
    derive_assignment_lhs, enclosing_block, extract_sink_variables, line_col_at, regex_ranges_any,
    regex_ranges_with_focus,
};
...
pub(crate) const FANCY_REGEX_GUARD: Duration = Duration::from_millis(300);
